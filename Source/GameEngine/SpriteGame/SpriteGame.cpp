...
bool SpriteGame::Initialize()
{
    ...
    bad::g_audio.AddSound("scream", "Assets/SpriteGame/Sounds/scream.mp3");
    bad::g_audio.AddSound("bullet", "Assets/SpriteGame/Sounds/bullet_lazer.mp3");
    bad::g_audio.AddSound("bomb", "Assets/SpriteGame/Sounds/bomb_lazer.mp3");
    bad::g_audio.AddSound("boom", "Assets/SpriteGame/Sounds/boom.mp3");

    m_titleText = std::make_shared<bad::Text>(bad::Resources().GetWithID<bad::Font>("font64", "Assets/SpriteGame/Fonts/font.ttf", 64));
    m_titleText->Create("AHHHH..", bad::Color8{ 255, 255, 255 });

    m_scoreText = new bad::Text(bad::Resources().GetWithID<bad::Font>("font32", "Assets/SpriteGame/Fonts/font.ttf", 32));
    m_livesText = new bad::Text(bad::Resources().GetWithID<bad::Font>("font32", "Assets/SpriteGame/Fonts/font.ttf", 32));
    return true;
}
